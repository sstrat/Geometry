...
lengths getLength(Point a, Point b, Point c)
{
    lengths result;
...
double getSemiperimeter(Point a, Point b, Point c)
{
...
double getArea(Point a, Point b, Point c)
{
    ...
    BC = result.lat2;
    AC = result.lat3;
    semiper = getSemiperimeter(a, b, c);
...
{
    double raza;
    raza = getArea(a, b, c) / getSemiperimeter(a, b, c);
    return raza;
}
